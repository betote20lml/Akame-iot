package com.akameiot.domain.formatter

import com.akameiot.domain.validation.isIndexMetric
import com.akameiot.domain.validation.formatIndexName
...
object MetricFormatter {
    ...
    fun formatName(metric: String, locale: Locale): String {
        ...
        if (metric.isIndexMetric()) {
            return metric.formatIndexName(locale) { base, loc ->
                formatName(base, loc)
            }
        }
